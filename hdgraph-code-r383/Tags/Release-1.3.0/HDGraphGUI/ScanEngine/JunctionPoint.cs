...
//    /// From http://www.codeproject.com/KB/files/JunctionPointsNet.aspx .
//    /// </summary>
...
//        /// </remarks>
//        /// <param name="junctionPoint">The junction point path</param>
//        /// <returns>The target of the junction point, or null when the specified path does not
//        /// exist, is invalid, or is not a junction point</returns>
//        public static string GetTargetOrNull(string junctionPoint)
//        {
//            if (!Directory.Exists(junctionPoint))
//                return null;
//            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericRead))
