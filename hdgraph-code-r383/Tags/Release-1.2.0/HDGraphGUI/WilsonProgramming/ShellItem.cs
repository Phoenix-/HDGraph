...
namespace WilsonProgramming
{
    public class ShellItem
    {
        ...
        private static ShellItem rootShellItem = null;
        ...
        /// <summary>
        /// Get the single existing instance of ShellItem;
        /// </summary>
        /// <returns></returns>
        public static ShellItem GetRootShellItem()
        {
            lock (typeof(ShellItem))
            {
                if (rootShellItem == null)
                {
                    rootShellItem = new ShellItem();
                }
            }
            return rootShellItem;
        }
        /// <summary>
